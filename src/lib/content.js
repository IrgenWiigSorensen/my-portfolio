...
export const skills = [
  {
    ...
    `,
      icons: [
        { src: HTMLIMG, alt: 'HTML logo' },
        { src: CSSIMG, alt: 'CSS logo' },
        { src: JSIMG, alt: 'JavaScript logo' },
        { src: TSIMG, alt: 'TypeScript logo' },
        { src: postgreSQLLogo, alt: 'PostgreSQL logo' },
      ],
    },
  },
  {
    ...
    `,
      icons: [
        ...
        { src: expressIMG, alt: 'Express logo' },
  ...
  },
  {
    ...
    `,
      icons: [
        { src: bootstrapIMG, alt: 'Bootstrap logo' },
        { src: npmIMG, alt: 'NPM logo' },
        { src: sassIMG, alt: 'Sass logo' },
        { src: stripeIMG, alt: 'Stripe logo' },
        { src: styledComponentsIMG, alt: 'Styled Components logo' },
      ],
    },
  },
];
