...
const JokeTeller = () => {
  ...
  const jokeTeller = async (joke) =>  {

   await getSpeech({ apiKey: "2c2153ec34b240f9ad5ee244c5ffc24c", language: "en-us", text: 'hello' })
  ...
  return (
      <div className="container">
        <button onClick={jokeTeller}>Joke</button>
        {/* <audio  onEnded={toggleJokeButton} controls></audio> */}
      </div>
  )
}
